...
![Tests](https://img.shields.io/badge/tests-106%2F106-brightgreen.svg)
...
🚀 **Waves 1–3 COMPLETE, Wave 4 OPENED** — 71 classes (66 library + 5 devkit tooling)
- Wave 4's Cartesian suite is in: SW_SCALE axis engine + line/bar/area/scatter
  charts; the demo's line chart streams live frame costs off the render bell
- 106 contract-assault tests passing
...
# the contract assault (106 tests, all assertions live)
