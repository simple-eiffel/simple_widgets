...
![Tests](https://img.shields.io/badge/tests-117%2F117-brightgreen.svg)
...
🚀 **Waves 1–3 COMPLETE, Wave 4 OPENED** — 77 classes (72 library + 5 devkit tooling)
- Wave 4's Cartesian suite is in: SW_SCALE axis engine + line/bar/area/scatter,
  pie/donut + funnel, gauge + sparkline, heatmap + treemap; the demo streams
  live frame costs into four instruments off one render-bell subscription
- 117 contract-assault tests passing
...
# the contract assault (117 tests, all assertions live)
